...
def reset_tables(engine):
    with engine.connect() as connection:
        ...
        connection.execute(sa.text("DROP TABLE IF EXISTS tester.transaction_history"))
        connection.execute(sa.text("DROP TABLE IF EXISTS tester.new_transaction_history"))
